...
Moreover, for cloud providers, all data he can collect is from physical machines or network. However, those data cannot clearly reflect the status inside the virtual machines. As a result, it may be very \textbf{difficult for cloud providers to provide accurate and effective monitoring and diagnostic service for users}.
